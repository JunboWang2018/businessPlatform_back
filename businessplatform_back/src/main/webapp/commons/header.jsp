...
<div id="header">
  <div class="header_inner">
    <div class="logo">
        ...
        <%--<div class="index_topad" id="playLogo" style="">
            <a href="/html/activity/1472179566.html" target="_blank">
              <img src="/businessPlatformManage/images/logo.jpg">
            </a>
        </div>--%>
		<a href="/businessPlatformManage/" class="trackref logoleft">
          <img src="/businessPlatformManage/images/logo.png">
		</a>
		<div class="logo-text">
			<img src="/businessPlatformManage/images/logo_word.jpg">
		</div>
		</div>
    <div class="index_promo"></div>
    <div class="search">
      <form action="/businessPlatformManage/data/product/selectProdListByKey" id="searchForm" name="query" method="GET">
        ...
        <input type="submit" value="" class="submit" onclick="search_keys('searchForm')">
      </form>
    ...
    <div class="shopingcar" id="topCart">
      <s class="setCart"></s><a href="/businessPlatformManage/data/cart/selectCartList" class="t" rel="nofollow">我的购物车</a><b id="cartNum">0</b>
